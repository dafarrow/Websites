...
if(isset($_POST['email'])) {
    ...
    $email_to = "jragsdale@natpak.net";
 
    $email_subject = "Service Request Online Form";
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message = "Service form details below.\n\n";
    ...
    $email_message .= "Street1: ".clean_string($street)."\n";
    $email_message .= "Street2: ".clean_string($street2)."\n";
