...
<body>
    ...
    <!-- -------------------->
        ...
        <article id="contents">
          ...
          <h2>Contact Us</h2>
<form name="contactform" method="post" action="scripts/send_form_email.php">
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="city" maxlength="40" size="35">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <label for="state">State: &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</label>
                                                <input type="text" name="state" maxlength="30" size="16">
                                                <label for="zip">&nbsp; Zip Code:</label>
                                                <input type="text" name="zip" maxlength="5" size="5">
                                                <tr>
                                                    <td valign="top" colspan="2">
                                                        <label for="model"><h3>Model Number of Machine:</h3></label>
