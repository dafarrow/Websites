...
<body>
    ...
    <img title="CaWiM" alt="" src="image/FilmMonitoring1.png">
    ...
    <div style="text-align: left;"><img style="width: 600px; height: 420px;" title="FilmMonitoringChart"

        alt="" src="image/FilmMonitoringChart.png"><br>
      ...
      <p style="text-align: left;">Reports can be generated based on data
        collected from the control system and sent users from an email list.<br>
         <div style="text-align: center;"><p><small>Screenshots of monitoring data and accounts.</small></p></div>
      <img style="width: 425px; height: 268px;" title="Film Monitoring Accounts"

        alt="Film Monitoring Accounts and Users" src="image/filmmonitoringaccount.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <img style="width: 325px; height: 275px;" title="Film Monitoring Data" alt="Film Monitoring Data Example"

        src="image/filmmonitoringdata.png"><br>
      <br>
