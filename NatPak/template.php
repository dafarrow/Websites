...
<body>
    ...
    <!-- -------------------->
        ...
        <article id="contents">
       <h2 style="text-align: center;">Film Monitoring</h2>
    <p>Wrapping System Reporting, Monitoring, and Remote access to a machine
      increases efficiency of the machine, and reduces downtown. This saves you
      money.</p>
    <h3 style="text-align: left;"><span style="color: #990000;">The Cut and
        Weigh in Motion System</span> (CaWiM)</h3>
    <img title="CaWiM" alt="" src="file:///C:/Users/Allison/Desktop/Natpakpages%206-26/images/FilmMonitoring1.png">
    <h3><span style="color: #990000;">Wrapper Monitoring System (WMS)</span></h3>
    <p>By installing a port the wrapper can be monitored in real time to supply
      information and reports to the end user, the machine service organization,
      and the machine manufacturer.</p>
    <p>Information can be gathered and used to ensure the ROI objectives are
      achieved and downtime is kept to a minimum.</p>
    <p><span style="font-weight: bold; color: #990000;">How can a Wrapper
        Monitoring System help you?</span> </p>
    <ul>
      <li>Alarms can be sent via SMS text message to in-house maintenance
        personnel or service organization to dispatch a technician.</li>
      <li>Film stretch efficiency is monitored to ensure film isn't being
        needlessly wasted.</li>
      <li>Film usage data can be gathered and reported.</li>
      <li>Remote access to the control system allows for changes to be made to
        the control system or aid in trouble shooting.</li>
      <li>Web based and accessible from anywhere.</li>
      <li>Access to the monitoring system can be set based on the user's
        requirements. <span style="font-style: italic;">i.e. read-only, read
          write etc.</span></li>
    </ul>
    <div style="text-align: center;"><img style="width: 657px; height: 451px;" title="FilmMonitoringChart"

        alt="" src="file:///C:/Users/Allison/Desktop/Natpakpages%206-26/images/FilmMonitoringChart.png"><br>
      <span style="font-weight: bold;"><br>
      </span>
      <div style="text-align: left;"><span style="font-weight: bold;">Data that
          can be acquired through Wrapper Monitoring Systems:</span></div>
      <ul style="text-align: left;">
        <li>Pre-stretch level.</li>
        <li>Film length</li>
        <li>Pallets per day</li>
        <li>Pallets per shift</li>
        <li>Pallets per roll</li>
        <li>Wrap pattern </li>
        <li>Alarm code</li>
        <li>Broken film</li>
        <li>Lack of film</li>
      ...
      <h3 style=" text-align: left;"><span style="color: #990000;">Film Pre-stretch
          Monitoring System</span></h3>
      <p style="text-align: left;">\The stand only system is attached directly
        to the film carriage allowing the monitoring system to be connected to
        the factory's SCADA system of the wrapper's main controller wirelessly.</p>
      <h3 style=" text-align: left;"><span style="font-weight: bold;">+/-2%
          Accurate on length and pre-stretch measuring.</span></h3>
      <h3 style=" text-align: left;"><span style="color: #990000;">Reports</span></h3>
      <p style="text-align: left;">Reports can be generated based on data
        collected from the control system and sent users from an email list.</p>
      <img style="width: 465px; height: 268px;" title="Film Monitoring Accounts"

        alt="Film Monitoring Accounts and Users" src="file:///C:/Users/Allison/Desktop/Natpakpages%206-26/images/filmmonitoringaccount.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <img style="width: 385px; height: 275px;" title="Film Monitoring Data" alt="Film Monitoring Data Example"

        src="file:///C:/Users/Allison/Desktop/Natpakpages%206-26/images/filmmonitoringdata.png"><br>
      <br>
 ...
 <w:WordDocument>  <w:View>Normal</w:View>
  ...
  </w:Compatibility>  <w:DoNotOptimizeForBrowser/>
 ...
 <w:LatentStyles DefLockedState="false" DefUnhideWhenUsed="false"  DefSemiHidden="false" DefQFormat="false" DefPriority="99"
  LatentStyleCount="371">  <w:LsdException Locked="false" Priority="1" QFormat="true" Name="Normal"/>
...
<style> /* Style Definitions */
 table.MsoNormalTable   {mso-style-name:"Table Normal";
    ...
    mso-pagination:none;    font-size:11.0pt;
...
<![endif]-->
        <p class="MsoNormal">For more information or to request a quote please
          contact National Packaging
          Equipment &amp; Service at 704-604-6682, <a href="mailto:jragsdale@natpak.net">jragsdale@natpak.net</a>.</p>
      </p>
      <p><br>
      </p>
      <ul style="text-align: left;">
